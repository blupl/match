<?php namespace Blupl\Match;

use Orchestra\Match\Providers\ServiceProvider;
...
//        $this->app->bind('Orchestra\Control\Contracts\Command\Synchronizer', 'Orchestra\Control\Command\Synchronizer');
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/match', 'blupl/match', $path.'/resources/config');
        $this->addLanguageComponent('blupl/match', 'blupl/match', $path.'/resources/lang');
        $this->addViewComponent('blupl/match', 'blupl/match', $path.'/resources/views');
...
//    }
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Match\Http\Handlers\MatchMenuHandler');
    }
...
//    }
    ...
    {
        $this->app['orchestra.extension.config']->map('blupl/match', [
